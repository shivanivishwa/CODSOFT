...
#Create a LabelFrame
labelframe= LabelFrame(win, text= "Rock Paper Scissor", font= ('Century 20 bold'),labelanchor= "n",bd=5,bg= "light pink",width= 600, height= 450, cursor= "target")
...
#Label for VS
l2= Label(labelframe, text="VS", font= ('Helvetica 18 bold'), bg="light pink")
...
label= Label(labelframe, text="", font=('Coveat', 25,'bold'), bg= "light pink")
label.pack(pady=150)
