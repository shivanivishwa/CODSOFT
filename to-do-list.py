...
if __name__ == "__main__":  
    ...
    guiWindow.configure(bg = "SkyBlue4")  
    ...
    header_frame = tk.Frame(guiWindow, bg = "SkyBlue4")  
    functions_frame = tk.Frame(guiWindow, bg = "SkyBlue4")  
    listbox_frame = tk.Frame(guiWindow, bg = "SkyBlue4")  
